          ...
          return (
            <div key={ep.id} className="relative group" style={{ animationDelay: `${200 + index * 50}ms` }}>
              ...
              <a
                ...
                className="absolute -top-1 -right-1 opacity-0 group-hover:opacity-100 transition-opacity bg-accent-info/90 backdrop-blur-sm rounded-full p-1 hover:bg-accent-info"
